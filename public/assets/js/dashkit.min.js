  ...
  "undefined"!=typeof Chart&&e&&new Chart(e,{
    ...
    options:{
      scales:{
        yAxes:[{
          ticks:{
            callback:function(e){return"$"+e+"k"}}}]}},
            data:{
              ...
              datasets:[{
                ...
                {label:"Organic",data:[2,12,35,25,36,25,34,16,4,14,15],hidden:!0}]}})}(),function(){var e=document.getElementById("ordersChart");"undefined"!=typeof Chart&&e&&new Chart(e,{
                type:"bar",
                options:
                {scales:
                  {yAxes:[{
